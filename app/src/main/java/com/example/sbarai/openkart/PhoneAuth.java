    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                Toast.makeText(PhoneAuth.this, "code sent", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_FAILED:
                ...
                Toast.makeText(PhoneAuth.this, "verification failed", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_SUCCESS:
                ...
                Toast.makeText(PhoneAuth.this, "verification success", Toast.LENGTH_LONG).show();
